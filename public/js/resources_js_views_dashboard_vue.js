...
/* harmony import */ var vue2_daterange_picker_dist_vue2_daterange_picker_css__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! vue2-daterange-picker/dist/vue2-daterange-picker.css */ "./node_modules/vue2-daterange-picker/dist/vue2-daterange-picker.css");
//
//
//
//
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  filters: {
    date: function date(value) {
      return moment__WEBPACK_IMPORTED_MODULE_6___default()(value).format('DD-MM-YYYY HH:mm:ss');
    }
  },
  computed: {
    user: function user() {
  ...
  methods: {
    ...
    bookRoom: function bookRoom(event) {
      ...
      this.$store.dispatch('bookRoom', this.reservation).then(function (response) {
        _this5.$bvToast.toast(response.message, {
          title: 'C\'est fait!',
          variant: 'success',
          solid: true,
          autoHideDelay: 5000
        ...
        _this5.$refs.submitReservationBtn.removeAttribute('disabled');
      });
    }
  },
  ...
  data: function data() {
    return {
      ...
      disabledDates: {
        dates: [new Date(2021, 3, 23), new Date(2016, 9, 17), new Date(2016, 9, 18)]
      },
      datePickerLocal: {
        direction: 'ltr',
                                            ...
                                            [
                                              _c("b-form-input", {
                                                attrs: {
                                                  ...
                                                  type: "text",
                                                  placeholder:
                                                    "Entrez le nom de la réservation",
                                                  required: ""
                                                },
                                                model: {
                                                  ...
                                                  _c(
                                                    "b-button",
                                                    {
                                                      ...
                                                      attrs: {
                                                        ...
                                                        type: "submit",
                                                        variant: "primary",
                                                        disabled: !_vm.validReservationForm
                                                      }
                                                    },
                                                    [
                                                      _vm._v(
